// cSpell:disable
// ============================================================
// Урок . conditional expressions
// ============================================================

fn main() {
    // ============================================================
    // Урок 009. УСЛОВНЫЕ ВЫРАЖЕНИЯ
    // ============================================================

    println!("=== Урок 009. УСЛОВНЫЕ ВЫРАЖЕНИЯ ===\n");
    ...
    // ============================================
    println!("\n=== РЕЗЮМЕ ===");
    println!("  Сравнение: ==  !=  >  <  >=  <=  — результат всегда bool");
    println!("  Сравнивать можно числа, char и строки (лексикографически)");
    println!("  Логические операторы: && (И), || (ИЛИ), ! (НЕ)");
    println!("  && и || используют короткое замыкание");
    println!("  if — это выражение: let status = if cond {{ a }} else {{ b }};");
    println!("  Обе ветки такого if должны возвращать один тип");
