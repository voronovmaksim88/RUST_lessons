...
fn main() {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║         Урок 008. БИТОВЫЕ ОПЕРАЦИИ В RUST                    ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
    ...
    println!("\nПереполнение при сдвиге:");
    println!("  b      = {:08b} ({})", b, b);
    // b << 1 НЕ паникует: выходящие за разрядность биты молча теряются (128u8 << 1 == 0).
    // Паника при сдвиге бывает только если ВЕЛИЧИНА сдвига >= ширины типа (например, x << 8 для u8).
    // wrapping_shl делает то же самое, но явно сообщает читателю о намерении "сдвиг с обрезанием".
    ...
    println!("\n✅ Урок по битовым операциям завершён!");
}
