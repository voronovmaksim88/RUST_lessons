...
fn main() {
    ...
    // as u8 обрезает все биты кроме младших 8 — это не деление по модулю,
    // а просто отбрасывание старших битов. Для отрицательных чисел результат
    // будет другим, чем при делении на 256 по правилам математики.
