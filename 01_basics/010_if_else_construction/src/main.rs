// ============================================================
// Урок . if else construction
// ============================================================

fn main() {
    // ============================================================
    // Урок 010. КОНСТРУКЦИИ IF-ELSE
    // ============================================================

    println!("=== Урок 010. КОНСТРУКЦИИ IF-ELSE ===\n");
    ...
    // ============================================
    println!("\n=== РЕЗЮМЕ ===");
    println!("  Условие ОБЯЗАНО быть типа bool: if number {{}} — ошибка");
    println!("  Скобки вокруг условия не нужны, фигурные скобки обязательны");
    println!("  Цепочки: if ... else if ... else");
    println!("  if — выражение: let x = if cond {{ a }} else {{ b }};");
    println!("  Ветки-выражения должны иметь одинаковый тип");
    println!("  Условия комбинируются через && || ! и вложенные if");
