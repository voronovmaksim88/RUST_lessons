...
fn main() {
    ...
    *y += 5;
    ...
    println!("\n   7.1 Синтаксис:");
    println!("   a..=b — включающий диапазон (стабильный, работает в паттернах)");
    println!("   a..b  — исключающий НЕ работает в стабильном Rust в паттернах!");
    ...
    println!("╠══════════════════════════════════════════════════════════════╣");
    println!("║  Range-паттерны: только a..=b (включающий) стабильный       ║");
